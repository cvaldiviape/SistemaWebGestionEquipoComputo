...
$x = $_GET['id_orden_trabajo']; //lo que envie desde "OrdenTrabajo.lista.views.php" lo guardo en $x.
...
<body style="background: url(../img/disco7.gif);">
    ...
    <form action="../controllers/Laptop.controlador.php?orden=registrar_laptop" method="POST">
        <input type="hidden" name="id_ot" value="<?= $x ?>">
        <label for="">Marca:</label>
        <select name="la_marca" id="">
            <option value="1">ASUS</option>
            <option value="2">DELL</option>
            <option value="3">HP</option>
            <option value="4">ACER</option>
            <option value="5">SAMSUMG</option>
            <option value="6">MSI</option>
            <option value="7">RAZE</option>
            <option value="8">SONY</option>
            <option value="9">TOSHIBA</option>
        </select>
        <label for="">Color:</label>
        <select name="la_color" id="">
        ...
        <input type="checkbox" name="cargador" id="" value="1">
        <label for="">Bateria:</label>
        <input type="checkbox" name="bateria" id="" value="1">
        <br>
    ...
    <div class="container mt-4" style="border: 4px solid rgb(255, 255, 255); border-radius: 15px; background: white;">
        <h3 class="mt-4" style="color: orangered; font-weight: bold;">REGISTRO DE LAPTOP:</h3>
        <form action="../controllers/Laptop.controlador.php?orden=registrar_laptop" method="POST" class="mt-2">
            <input type="hidden" name="id_ot" value="<?= $x ?>">
            <div class="form-row">
                <label class="col-form-label" for="" style="font-size: 20px; font-weight: bold;">Marca:</label>
                <div class="rows">
                    <div class="form-group">
                        <select class="form-control" name="la_marca" id="">
                            <option value="1">ASUS</option>
                            <option value="2">DELL</option>
                            <option value="3">HP</option>
                            <option value="4">ACER</option>
                ...
                <div class="rows">
                    <div class="form-group">
                        <select class="form-control" name="la_color" id="">
                            <option value="1">NEGRO</option>
                            <option value="2">NEGRO/BLANCO</option>
                            <option value="3">NEGRO/ROJO</option>
                            <option value="4">NEGRO/AZUL</option>
                ...
                <div class="row">
                    <div class="form-group form-check ml-5">
                        <label class="col-form-label" for="" style="font-size: 20px; font-weight: bold;">Cargador:</label>
                        <input type="checkbox" name="cargador" id="" value="1">
                    </div>
                    <div class="form-group form-check ml-3">
                        <label class="col-form-label" for="" style="font-size: 20px; font-weight: bold;">Bateria:</label>
                        <input type="checkbox" name="bateria" id="" value="1">
                    </div>
                </div>
            </div>
