...
<head>
    ...
    <title>Tecnico.pc.detalle</title>
</head>
...
<body style="background: url(../img/disco6.gif);">
    ...
    //$fila = PcDAO::getDetallePcXid($id_equipo);
    /*if ($fila['TARJETA_VIDEO'] == '0') {
        $tarjeta_video = 'NO';
    } else {
        $tarjeta_video = 'SI';
    }
    ...
    */?>
    ...
    <input type="text" value="<?//= $fila['CASE_MARCA'] ?>" readonly="readonly" size="10">
    <label for="">Color:</label>
    <input type="text" value="<?//= $fila['CASE_COLOR'] ?>" readonly="readonly" size="10">
    <label for="">Tarjeta de video:</label>
    <input type="text" value="<?//= $tarjeta_video ?>" readonly="readonly" size="1">
    <label for="">Monitor:</label>
    <input type="text" value="<?//= $monitor ?>" readonly="readonly" size="1">
    <br>
    ...
    <div class="container mb-4 mt-4" style="border: 4px solid rgb(255, 255, 255); border-radius: 15px; background: white;">
        <h3 class="mt-4" style="color: rgb(255, 0, 0); font-weight: bold;">DETALLE DE PC:</h3>

        <div class="form-row">
            <label class="col-form-label" style="font-size: 20px; font-weight: bold;" for="nombre">Marca:</label>
            <div class="form-group">
                <input type="text" class="form-control" value="<?= $fila['CASE_MARCA']; ?>" readonly="readonly" size="10">
            </div>
            <label class="col-form-label" style="font-size: 20px; font-weight: bold;" for="apellido">Color:</label>
            <div>
                <input type="text" class="form-control" value="<?= $fila['CASE_COLOR']; ?>" readonly="readonly" size="10">
            </div>
            <label class="col-form-label" style="font-size: 20px; font-weight: bold;" for="celular">Tarjeta de video:</label>
            <div>
                <input type="text" class="form-control" value="<?= $tarjeta_video; ?>" readonly="readonly" size="10">
            </div>
            <label class="col-form-label" style="font-size: 20px; font-weight: bold;" for="celular">Monitor:</label>
            <div>
                <input type="text" class="form-control" value="<?= $monitor; ?>" readonly="readonly" size="10">
            </div>
        </div>
