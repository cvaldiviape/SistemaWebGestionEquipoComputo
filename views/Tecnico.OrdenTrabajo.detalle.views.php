...
<body style="background: url(../img/disco6.gif);">
    ...
    <!--LO COLOQUE EN UN "DIV" SOLO PARA OCULTARLO
    <div>
        ...
        <br>
        <br>
        <a href="Tecnico.OrdenTrabajo.lista.views">VOLVER</a>
    </div>-->

    <div class="container mb-4 mt-4" style="border: 4px solid rgb(255, 255, 255); border-radius: 15px; background: white;">
        <h3 class="mt-4" style="color: rgb(255, 0, 0); font-weight: bold;">DETALLE DE ORDEN DE TRABAJO:</h3>
        ...
        <a class="btn btn-warning mb-4" style="font-weight: bold;" href="Tecnico.OrdenTrabajo.lista.views.php">VOLVER</a>
    </div>
